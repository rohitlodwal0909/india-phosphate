...
var processChildren = (children, outline, pill) => {
  return import_react5.Children.map(children, (child, index) => {
    if ((0, import_react5.isValidElement)(child)) {
      const positionInGroupProp = child.type == Button ? { positionInGroup: determinePosition(index, import_react5.Children.count(children)) } : {};
...
// node_modules/flowbite-react/dist/esm/components/Clipboard/ClipboardWithIcon.mjs
var ClipboardWithIcon = (0, import_react15.forwardRef)(
  ({ valueToCopy, icon: Icon = FaClipboardList, theme: customTheme = {}, className, ...rest }, ref) => {
    const [isJustCopied, setIsJustCopied] = (0, import_react15.useState)(false);
...
var ClipboardWithIconText = (0, import_react16.forwardRef)(
  ({ valueToCopy, icon: Icon = FaClipboardList, label = "Copy", theme: customTheme = {}, className, ...rest }, ref) => {
    const [isJustCopied, setIsJustCopied] = (0, import_react16.useState)(false);
...
// node_modules/flowbite-react/dist/esm/components/Clipboard/Clipboard.mjs
var ClipboardComponent = (0, import_react17.forwardRef)(
...
var useThemeMode = () => {
  const [mode, setMode] = (0, import_react20.useState)(getInitialMode(getThemeMode()));
...
var DatepickerContext = (0, import_react22.createContext)(void 0);
function useDatePickerContext() {
  const context = (0, import_react22.useContext)(DatepickerContext);
  if (!context) {
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
    (0, import_jsx_runtime30.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index) => (0, import_jsx_runtime30.jsx)("span", { className: theme2.header.title, children: day }, index)) }),
    (0, import_jsx_runtime30.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index) => {
...
var DatepickerViewsDecades = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime31.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index) => {
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime32.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index) => {
...
var DatepickerViewsYears = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime33.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index) => {
...
var DatepickerRender = ({
  ...
  const effectiveDefaultView = (0, import_react23.useMemo)(() => {
    return defaultValue ? getFirstDateInRange(defaultValue, minDate, maxDate) : /* @__PURE__ */ new Date();
  }, []);
  const [isOpen, setIsOpen] = (0, import_react23.useState)(open);
  const [view, setView] = (0, import_react23.useState)(Views.Days);
  const [selectedDate, setSelectedDate] = (0, import_react23.useState)(value ?? initialDate);
  const [viewDate, setViewDate] = (0, import_react23.useState)(value ?? effectiveDefaultView);
  const inputRef = (0, import_react23.useRef)(null);
  const datepickerRef = (0, import_react23.useRef)(null);
  ...
  return (0, import_jsx_runtime34.jsx)(
    DatepickerContext.Provider,
    {
      ...
      children: (0, import_jsx_runtime34.jsxs)("div", { className: twMerge(theme2.root.base, className), children: [
        !inline && (0, import_jsx_runtime34.jsx)(
          TextInput,
          {
        ...
        (isOpen || inline) && (0, import_jsx_runtime34.jsx)("div", { ref: datepickerRef, className: twMerge(theme2.popup.root.base, inline && theme2.popup.root.inline), children: (0, import_jsx_runtime34.jsxs)("div", { className: theme2.popup.root.inner, children: [
...
var Datepicker = (0, import_react23.forwardRef)(DatepickerRender);
...
var DrawerContext = (0, import_react24.createContext)(void 0);
function useDrawerContext() {
  const context = (0, import_react24.useContext)(DrawerContext);
  if (!context) {
...
var DropdownContext = (0, import_react27.createContext)(void 0);
function useDropdownContext() {
  const context = (0, import_react27.useContext)(DropdownContext);
  if (!context) {
...
var DropdownItem = (0, import_react29.forwardRef)(
...
var Trigger = ({
  ...
  if (renderTrigger) {
    ...
    return (0, import_react31.cloneElement)(triggerElement, { ref: refs.setReference, disabled, ...a11yProps, ...triggerElement.props });
  }
  return inline ? (0, import_jsx_runtime41.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime41.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownComponent = ({
  ...
  const [activeIndex, setActiveIndex] = (0, import_react31.useState)(null);
  const [selectedIndex, setSelectedIndex] = (0, import_react31.useState)(null);
  const [buttonWidth, setButtonWidth] = (0, import_react31.useState)(void 0);
  const elementsRef = (0, import_react31.useRef)([]);
  const labelsRef = (0, import_react31.useRef)([]);
  ...
  const handleSelect = (0, import_react31.useCallback)((index) => {
    setSelectedIndex(index);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react31.useCallback)(
    (index) => {
      if (open) {
...
var FileInput = (0, import_react32.forwardRef)(
...
var FloatingLabel = (0, import_react33.forwardRef)(
  ({
    label,
    helperText,
    color = "default",
...
var HRIcon = (0, import_react34.forwardRef)(
...
var HRSquare = (0, import_react35.forwardRef)(
...
var HRText = (0, import_react36.forwardRef)(
...
var HRTrimmed = (0, import_react37.forwardRef)(
  ({ theme: customTheme = {}, className, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/HR/HR.mjs
var HRComponent = (0, import_react38.forwardRef)(({ theme: customTheme = {}, className, ...props }, ref) => {
...
var NavbarContext = (0, import_react39.createContext)(void 0);
function useNavbarContext() {
  const context = (0, import_react39.useContext)(NavbarContext);
  if (!context) {
...
var NavbarComponent = ({
  ...
  const [isOpen, setIsOpen] = (0, import_react40.useState)(menuOpen);
...
var MegaMenuDropdown = ({
  ...
  const [labelledBy, setLabelledBy] = (0, import_react41.useState)(void 0);
...
var MegaMenuDropdownToggle = ({
  ...
  const [controls, setControls] = (0, import_react42.useState)(void 0);
  const [isExpanded, setExpanded] = (0, import_react42.useState)(void 0);
...
var ModalContext = (0, import_react43.createContext)(void 0);
function useModalContext() {
  const context = (0, import_react43.useContext)(ModalContext);
  if (!context) {
...
var ModalHeader = ({
  ...
  const innerHeaderId = (0, import_react44.useId)();
...
// node_modules/flowbite-react/dist/esm/components/Modal/Modal.mjs
var ModalComponent = (0, import_react46.forwardRef)(
  ({
    children,
    className,
    dismissible = false,
    ...
    const [headerId, setHeaderId] = (0, import_react46.useState)(void 0);
...
function Popover({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react48.useState)(Boolean(initialOpen));
  ...
  if (!(0, import_react48.isValidElement)(children)) {
    throw Error("Invalid target element");
  }
  const target = (0, import_react48.useMemo)(() => {
    return (0, import_react48.cloneElement)(
      children,
      getReferenceProps({
        ref,
...
var Progress = ({
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: (0, import_jsx_runtime80.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [
    ...
    (0, import_jsx_runtime80.jsx)("div", { className: twMerge(theme2.base, theme2.size[size], className), children: (0, import_jsx_runtime80.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size]), children: [
...
var RangeSlider = (0, import_react51.forwardRef)(
...
var RatingContext = (0, import_react52.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react52.useContext)(RatingContext);
  if (!context) {
...
var RatingComponent = ({ children, className, size = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime85.jsx)(RatingContext.Provider, { value: { theme: theme2, size }, children: (0, import_jsx_runtime85.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var SidebarContext = (0, import_react54.createContext)(void 0);
...
var SidebarItemContext = (0, import_react55.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react55.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({
  ...
  const [isOpen, setOpen] = (0, import_react56.useState)(open);
  const { theme: rootTheme, isCollapsed } = useSidebarContext();
  const theme2 = mergeDeep(rootTheme.collapse, customTheme);
  (0, import_react56.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react57.forwardRef)(
  ({
    active: isActive,
    as: Component = "a",
    children,
...
var TableBodyContext = (0, import_react59.createContext)(void 0);
function useTableBodyContext() {
  const context = (0, import_react59.useContext)(TableBodyContext);
  if (!context) {
...
var TableContext = (0, import_react60.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react60.useContext)(TableContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableBody.mjs
var TableBody = (0, import_react61.forwardRef)(
...
var TableCell = (0, import_react62.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableHeadContext = (0, import_react63.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react63.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/dist/esm/components/Table/TableHead.mjs
var TableHead = (0, import_react64.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
    const { theme: rootTheme } = useTableContext();
...
var TableHeadCell = (0, import_react65.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
var TableRow = (0, import_react66.forwardRef)(
  ({ children, className, theme: customTheme = {}, ...props }, ref) => {
...
// node_modules/flowbite-react/dist/esm/components/Table/Table.mjs
var TableComponent = (0, import_react67.forwardRef)(
...
var TabsComponent = (0, import_react68.forwardRef)(
  ({ children, className, onActiveTabChange, variant = "default", theme: customTheme = {}, ...props }, ref) => {
    ...
    const tabs = (0, import_react68.useMemo)(
      () => import_react68.Children.map(
        import_react68.Children.toArray(children),
        ({ props: props2 }) => props2
      ),
      [children]
    );
    const tabRefs = (0, import_react68.useRef)([]);
    const [activeTab, setActiveTab] = (0, import_react68.useState)(
      Math.max(
        0,
        tabs.findIndex((tab) => tab.active)
      )
    );
    const [focusedTab, setFocusedTab] = (0, import_react68.useState)(-1);
    ...
    return (0, import_jsx_runtime101.jsxs)("div", { className: twMerge(theme2.base, className), children: [
      (0, import_jsx_runtime101.jsx)(
        "div",
        {
          ...
          ...props,
          children: tabs.map((tab, index) => (0, import_jsx_runtime101.jsxs)(
            "button",
            {
              type: "button",
      ...
      (0, import_jsx_runtime101.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index) => (0, import_jsx_runtime101.jsx)(
        "div",
        {
...
var Textarea = (0, import_react69.forwardRef)(
...
var TimelineContentContext = (0, import_react70.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react70.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineContext = (0, import_react71.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react71.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react72.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react72.useContext)(TimelineItemContext);
  if (!context) {
...
var ToastContext = (0, import_react73.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react73.useContext)(ToastContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react74.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react74.useState)(false);
...
var ToggleSwitch = (0, import_react75.forwardRef)(
  ({
    checked,
    className,
    color = "blue",
    ...
    const id = (0, import_react75.useId)();
