...
function SvgAx(props) {
  return React.createElement(
    "svg",
    __assign({ width: "1em", height: "1em", viewBox: "0 0 513 336", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
...
function SvgTl(props) {
  return React.createElement(
    "svg",
    __assign({ width: "1em", height: "1em", viewBox: "0 0 512 336", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
  ...
  var filterSearch = function(e) {
    ...
    var filteredCountriesOptions2 = countriesOptions.filter(function(key) {
      ...
      if (isCustomLabelObject(label)) {
        return isCountryLabelMatch(label === null || label === void 0 ? void 0 : label.primary, value) || isCountryLabelMatch(label === null || label === void 0 ? void 0 : label.secondary, value);
      }
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("span", { className: styles.selectValue }, validSelectedValue ? import_react.default.createElement(
        ...
        null,
        import_react.default.createElement("span", { className: styles.selectFlag, "data-testid": "".concat(rfsKey, "-selected-flag") }, getSelectedFlag()),
    ...
    !disabled && isDropdownOpen && import_react.default.createElement(
      ...
      searchable && import_react.default.createElement(
        ...
        import_react.default.createElement("input", { type: "text", name: "".concat(rfsKey, "-q"), autoComplete: "off", value: filterValue, placeholder: searchPlaceholder || defaultSearchPlaceholder, ref: filterTextRef, onChange: filterSearch, autoFocus: true })
      ),
      options.map(function(countryCode) {
        ...
        return import_react.default.createElement(
          "li",
          { key: countryCode, id: "".concat(rfsKey, "-").concat(countryCode), role: "option", tabIndex: 0, className: classnames(styles.selectOption, (_a2 = {}, _a2[styles.selectOptionWithlabel] = showOptionLabel, _a2)), onClick: function() {
