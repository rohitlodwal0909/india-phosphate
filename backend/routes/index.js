...
const VisitPlannerRoutes = require("../routes/marketing/VisitPlannerRoutes");
...
const BillRoutes = require("../routes/account/BillRoutes");
...
router.use("/api", authMiddleware, RmCodeRoutes);
router.use("/api", authMiddleware, PmCodeRoutes);
...
router.use("/api", authMiddleware, EquipmentRoutes);
...
router.use("/api", authMiddleware, BillRoutes);
