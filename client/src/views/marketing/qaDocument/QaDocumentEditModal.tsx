...
import { updateQaDocument } from 'src/features/marketing/QaDocumentSlice';
...
const QaDocumentEditModal: React.FC<Props> = ({ openModal, setOpenModal, selectedRow }) => {
  ...
  return (
    <Modal show={openModal} size="7xl" onClose={() => setOpenModal(false)}>
      <Modal.Header>Edit QA Documents</Modal.Header>
            ...
            {coaItems.map((item, index) => (
              <div key={index} className="grid grid-cols-12 gap-4 mb-4 items-end">
                ...
                <div className="col-span-2">
                  ...
                  <Select
                    options={qaOptions}
                    value={qaOptions.find((o) => o.value === item.qa_person_id)}
                ...
                <div className="col-span-2">
                  ...
                  <Select
                    ...
                    value={marketingOptions.find((o) => o.value === item.received_marketing_id)}
                ...
                <div className="col-span-2">
                  ...
                  <Select
                    options={marketingOptions}
                    value={marketingOptions.find((o) => o.value === item.share_customer_by)}
