...
import EditDepartmentMasterModal from "./EditDepartmentMasterModal";
import AddDepartmentMasterModal from "./AddDepartmentMasterModal";
import { deleteDepartmentMaster, GetDepartmentMaster } from "src/features/master/DepartmentMaster/DepartmentMasterSlice";
...
const DepartmentMasterTable = () => {
  ...
  const { DepartmentMasterdata, loading } = useSelector((state: any) => state.departmentmaster);
  ...
  const filteredItems = (DepartmentMasterdata || []).filter((item: any) => {
