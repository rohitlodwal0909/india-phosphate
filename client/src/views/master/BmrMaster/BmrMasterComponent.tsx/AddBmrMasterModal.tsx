...
const AddBmrMasterModal = ({ show, setShowmodal, logindata }) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const result = await dispatch(addBmrMaster(formData)).unwrap();
      toast.success(result.message || 'BMR  created successfully');
