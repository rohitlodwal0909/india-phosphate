...
const PendingOrderTable = () => {
  ...
  const handleDelete = async (userToDelete: any) => {
    ...
    try {
      await dispatch(
        deletePendingOrder({ id: userToDelete?.id, user_id: logindata?.admin?.id }),
      ).unwrap();
      dispatch(GetPendingOrder());
  ...
  return (
    <div>
      ...
      />
      <AddPendingOrderModal
        setShowmodal={setAddmodal}
        show={addmodal}
        logindata={logindata}
        rmcodedata={rmcodedata}
      />
      <EditPendingOrderModal
        show={editmodal}
        setShowmodal={setEditmodal}
        PendingOrderData={selectedrow}
        logindata={logindata}
        rmcodedata={rmcodedata}
      />
    </div>
