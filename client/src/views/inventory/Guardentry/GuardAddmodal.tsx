...
const GuardAddmodal: React.FC<GuardAddModalProps> = ({
  placeModal,
  modalPlacement,
  setPlaceModal,
  logindata,
              ...
              <TextInput
                ...
                helperText={
                  errors.vehicle_number && (
                    <span className="text-red-500 text-xs">{errors.vehicle_number}</span>
                  )
                }
              />
            </div>
            ...
            <>
              <div className="sm:col-span-6 col-span-12">
                ...
                <TextInput
                  ...
                  helperText={
                    errors.sender_name && (
                      <span className="text-red-500 text-xs">{errors.sender_name}</span>
                    )
                  }
                />
              </div>
