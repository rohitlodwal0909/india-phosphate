...
import { Approvemodule,  Holdmodule, Rejectmodule } from "src/features/Inventorymodule/Qcinventorymodule/QcinventorySlice";
 ...
 const { selectedIconId } = useContext(CustomizerContext) || {};
  ...
  return (
    <>
        ...
        <>
          <div className="p-4">
           ...
           className="me-2 p-2 border rounded-md border-gray-300" />
              <select id="status" value={filters.status} className=" border border-pink-200 focus:border-gray-300 focus:ring-0 rounded-md" onChange={(e) => setFilters(prev => ({ ...prev, status: e.target.value }))}>
      ...
      <Approvemodal handleConfirmDelete={handleConfirmApprove} isOpen={approvemodal} setIsOpen={setApprovemodal} selectedUser={selectedRow} />
      <Rejectmodal handleConfirmDelete={handleConfirmReject} isOpen={rejectmodal} setIsOpen={setRejectmodal} selectedUser={selectedRow} />
      <Holdmodal handleConfirmDelete={handleConfirmHold} isOpen={holdOpen} setIsOpen={setholdOpen} selectedUser={selectedRow} />
    </>
  );
}
