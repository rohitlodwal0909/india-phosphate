...
const GradeWiseCard = ({ grades = [] }: any) => {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="flex items-center justify-between px-5 py-4 border-b bg-gray-50">
        <div>
          <h3 className="text-lg font-semibold text-gray-800">Grade Performance</h3>
          <p className="text-sm text-gray-500">Grade-wise quantity and sales summary</p>
        </div>
