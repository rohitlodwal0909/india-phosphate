...
const RemainingTaskList: React.FC<RemainingTaskListProps> = ({ open, onClose, tasks = [] }) => {
  ...
  return (
    <Modal show={open} onClose={onClose} size="7xl">
      <Modal.Header>
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Remaining / Tasks</h2>

          <p className="text-sm text-gray-500 mt-1">Total Remaining Tasks: {tasks.length}</p>
        </div>
      </Modal.Header>
      ...
      <Modal.Body>
        {tasks.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h3 className="text-xl font-semibold text-gray-700">No Remaining Tasks Found</h3>
...
export default RemainingTaskList;
