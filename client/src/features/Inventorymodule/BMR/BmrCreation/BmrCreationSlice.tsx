...
export const GetBmrRecords = createAsyncThunk(
  "Bmr/record",
...
export const saveLineClearance= createAsyncThunk(
  ...
  async (newCheckin:any, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${apiUrl}/save-bmr-line-clearance`, newCheckin);
      return response.data;
    } catch (error) {
      // Optional: Log for debugging
      console.error("Add checkin error:", error);
  ...
  async (
    ...
    try {
      const response = await axios.put(
        `${apiUrl}/update-bmr-line-clearance/${id}`,
        payload
      );
