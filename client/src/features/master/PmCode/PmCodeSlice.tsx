...
export const GetPmCode = createAsyncThunk(
  "GetPmCode/fetch",
  async (_, thunkAPI) => {
    try {
...
export const GetPmRawMaterial = createAsyncThunk(
  "GetPmRaw/fetch",
  async (id, thunkAPI) => {
    try {
...
export const addPmCode = createAsyncThunk(
  ...
  async (formdata:any, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${apiUrl}/store-pm-code`,
        formdata);
      return response.data;
    } catch (error) {
...
export const addpmrawmaterial = createAsyncThunk(
  ...
  async (formdata:any, { rejectWithValue }) => {
    try {
      const response = await axios.post(`${apiUrl}/store-pm-raw-material`,
        formdata);
      return response.data;
    } catch (error) {
      // Return a rejected action containing the error message
  ...
  const response = await axios.put(
     `${apiUrl}/update-pm-code/${updatedUser?.id}`,
    updatedUser
  );
  return response.data;
});

export const deletePmCode = createAsyncThunk<any, {id:string,user_id:any}, { rejectValue: any }>(
  "deletePmCode/delete",
